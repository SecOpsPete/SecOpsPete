# 🛡️ Cybersecurity, IT and Customer Success Projects by Peter Van Rossum
...
- 🛡️ **[Remote Support Backdoor - CTF](https://github.com/SecOpsPete/threat-hunting-scenarios/blob/main/remote-support-backdoor/README.md)**  
  Reconstructs a routine-looking remote support session that was actually a staged misdirection: I trace initial script execution, short-lived clipboard probes, file staging in public folders, network reachability checks, and layered persistence. The write-up provides KQL pivots, investigation notes, and evidence images.
